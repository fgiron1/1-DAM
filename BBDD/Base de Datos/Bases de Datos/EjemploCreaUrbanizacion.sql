...
CREATE TABLE URPersonas(
	...
	CONSTRAINT FKViviendaPersonaVive Foreign Key (IDViviendaVive) REFERENCES URViviendas (ID) ON DELETE No Action ON UPDATE Cascade,
	CONSTRAINT FKPareja FOREIGN KEY (IDPareja) REFERENCES URPersonas (ID) ON DELETE No Action ON UPDATE Cascade, 
